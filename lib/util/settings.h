...
#define QUICK_KF_CHECK_LVL_INITIAL 4


constexpr static const int PYRAMID_LEVELS = (SE3TRACKING_MAX_LEVEL > SIM3TRACKING_MAX_LEVEL ? SE3TRACKING_MAX_LEVEL : SIM3TRACKING_MAX_LEVEL);
constexpr static const int QUICK_KF_CHECK_LVL=(QUICK_KF_CHECK_LVL_INITIAL >= PYRAMID_LEVELS ? PYRAMID_LEVELS-1 : QUICK_KF_CHECK_LVL_INITIAL);
