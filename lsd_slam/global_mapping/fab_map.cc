...
// 	//fabMap = new of2::FabMapFBO(clTree, 0.39, 0, options, 3000, 1e-6, 1e-6, 512, 9);
    ...
    detector = cv::xfeatures2d::StarDetector::create(32,10,18,18,20);//new cv::StarFeatureDetector(32, 10, 18, 18, 20);
    cv::Ptr<cv::DescriptorExtractor> extractor =  cv::xfeatures2d::SURF::create(1000.0,4,2,false,true);
